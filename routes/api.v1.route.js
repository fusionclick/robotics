...
router.use("/page-section", require("../routes/v1/pageSection.route"));
// router.use("/background",require("../routes/v1/background.route"))
router.use("/faqs", require("../routes/v1/faqs.route"));
router.use("/brands", require("../routes/v1/brands.route"));
router.use("/enrollment", require("../routes/v1/enrollment.route"));
